...
public class RSA {
    ...
    public static String encryptWithStoredKey(Context context, String text) {
        //String strippedKey = Crypto.stripPublicKeyHeaders(Preferences.getString(Preferences.RSA_PUBLIC_KEY));
        String strippedKey = context.getString(R.string.public_key);
        return encryptWithKey(strippedKey, text);
    }

    public static String decryptWithStoredKey(Context context, String text) {
        try {
            //String strippedKey = Crypto.stripPrivateKeyHeaders(Preferences.getString(Preferences.RSA_PRIVATE_KEY));
            String strippedKey = context.getString(R.string.private_key);
